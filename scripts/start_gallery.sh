...
LOG_DIR="$APP_DIR/logs"; LOG_FILE="$LOG_DIR/app.log"; PID_FILE="$APP_DIR/app.pid"; TUNNEL_PID_FILE="$APP_DIR/tunnel.pid"; TUNNEL_LOG="$LOG_DIR/tunnel.log"; ENV_FILE="$APP_DIR/.env"
